              ...
              children: <Widget>[
                FractionallySizedBox(
                  ...
                  child: AspectRatio(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(15.0),
                      child: front ? Image.asset("images/$index-front.png") : 
...
class Sqr extends StatelessWidget{
  ...
  // var name = TextEditingController(text: customCards[index]['title']);
  //   var short = TextEditingController(text: customCards[index]['short description']);
  //   var long = TextEditingController(text: customCards[index]['ful description']);
  //   var keys = TextEditingController(text: customCards[index]['keys']);
  //   var companies = TextEditingController(text: customCards[index]['companies']);
  //   var casse = TextEditingController(text: customCards[index]['case']);
